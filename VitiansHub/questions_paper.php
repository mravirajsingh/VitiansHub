...
<?php
   ...
   $urow=mysqli_fetch_assoc($uquery);
     ...
     $query="select * from questions_paper";
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper" >
            <div class="alert alert-info">
               <h2 style="color:black;">Previous year question</h2>
            </div>
            <div class="table-responsive">
               <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                  <tr>
                     <form action="uploadques.php" method="post" enctype="multipart/form-data">
                        ...
                        <td><input type="text" name="year" class="text"  required="required" placeholder="Year"></td>
